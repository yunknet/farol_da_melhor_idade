  ...
  <section class="section">
    <div class="container" style="max-width:800px">
      <div class="section-header">
        <div class="section-label"><i class="fas fa-shield-alt"></i> LGPD</div>
      ...
      <div style="background:var(--white);padding:40px;border-radius:var(--radius-lg);box-shadow:var(--shadow);line-height:2;color:var(--text-light)">
        ...
        <h3 style="margin:24px 0 12px">3. Compartilhamento</h3>
        <p>Não compartilhamos dados pessoais com terceiros, exceto quando necessário para o funcionamento dos serviços (ex: envio de e-mails de confirmação) ou por determinação legal.</p>

        <h3 style="margin:24px 0 12px">4. Armazenamento e Segurança</h3>
        <p>Os dados são armazenados em servidores seguros com certificado SSL. Adotamos medidas técnicas e administrativas para proteger seus dados contra acessos não autorizados.</p>

        <h3 style="margin:24px 0 12px">5. Direitos do Titular</h3>
        <p>Você pode solicitar a qualquer momento: acesso aos seus dados; correção de dados incompletos ou incorretos; exclusão dos seus dados pessoais; portabilidade dos dados.</p>

        <h3 style="margin:24px 0 12px">6. Cookies</h3>
